...
#else
    { "ÀÐ²½", SV_NAME, (Widget) 0, 0, 0, FALSE, TRUE }, /*20*/
    { "¥¹¥é¥¤¥à", SV_NAME, (Widget) 0, 0, 0, FALSE, TRUE },
    { "ÃâÂ©", SV_NAME, (Widget) 0, 0, 0, FALSE, TRUE },
    { "¿©ÆÇ", SV_NAME, (Widget) 0, 0, 0, FALSE, TRUE },
...
#else
    { "ÉâÍ·", SV_NAME, (Widget) 0, 0, 0, FALSE, TRUE },
    { "Èô¹Ô", SV_NAME, (Widget) 0, 0, 0, FALSE, TRUE },
    { "µ³¾è", SV_NAME, (Widget) 0, 0, 0, FALSE, TRUE },
#endif
...
#else
    { "ÌÕÌÜ", SV_NAME, (Widget) 0, 0, 0, FALSE, TRUE }, /*30*/
    { "¼ªÏ¸", SV_NAME, (Widget) 0, 0, 0, FALSE, TRUE },
    { "âÁÚô", SV_NAME, (Widget) 0, 0, 0, FALSE, TRUE },
    { "º®Íð", SV_NAME, (Widget) 0, 0, 0, FALSE, TRUE },
